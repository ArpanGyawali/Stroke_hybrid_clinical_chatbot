...
class RAGTool(BaseTool):
    ...
    def __init__(self, data_loader: DataLoader, llm: BaseLLM):
        super().__init__(data_loader=data_loader, llm=llm)
    ...
    def _run(self, query: str) -> str:
        ...
        try:
            ...
            synthesis_prompt = PromptTemplate(
                ...
                template="""
You are a clinical AI assistant. Based on the following clinical documents, provide a comprehensive answer to the user's query.
...
"""
            ...
            source_info = "\n\nSources consulted:\n" + "\n".join([
                f"- {source.split('/')[-1]}" for source in set(sources)
            ])
